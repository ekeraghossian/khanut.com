package com.khanut.gateway.security;
...
import com.khanut.gateway.repositories.JwtTokenRepository;
...
public class JwtTokenProvider {
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new KhanutUserDetails(userName,roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
